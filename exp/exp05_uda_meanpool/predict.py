"""
exp/exp05_uda_meanpool/predict.py
==================================
Ensemble prediction for exp05 (UDA + mean pooling).
...
Usage
-----
    python exp/exp05_uda_meanpool/predict.py            # latest run
    python exp/exp05_uda_meanpool/predict.py --run 01   # specific run
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="exp05 ensemble predictor")
    parser.add_argument(
        "--run",
        type=str,
        default=None,
