"""
exp/exp08_cluster_pseudo_siebert_sched_smooth/predict.py
=========================================================
Ensemble prediction for exp08 (cluster pseudo-labeling + cosine scheduler
+ label smoothing, siebert encoder).
...
Usage
-----
    python exp/exp08_cluster_pseudo_siebert_sched_smooth/predict.py            # latest run
    python exp/exp08_cluster_pseudo_siebert_sched_smooth/predict.py --run 01   # specific run
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="exp08 ensemble predictor")
