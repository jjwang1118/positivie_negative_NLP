"""
exp/exp06_cluster_pseudo/predict.py
=====================================
Ensemble prediction for exp06 (cluster pseudo-labeling).
...
Usage
-----
    python exp/exp06_cluster_pseudo/predict.py            # latest run
    python exp/exp06_cluster_pseudo/predict.py --run 01   # specific run
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="exp06 ensemble predictor")
