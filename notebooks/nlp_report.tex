...
\begin{@twocolumnfalse}
  \begin{center}
    ...
    \begin{tabular}{c}
      Author A \\
      \small 114423002  \\
      \small \texttt{jjwang1118@gmail.com} \\[2pt]
      \small \href{https://github.com/jjwang1118/positivie_negative_NLP/tree/main}%
        {\texttt{github.com/jjwang1118/positivie\_negative\_NLP}}
    \end{tabular}
  \end{center}
  \vspace{4pt}
  \begin{abstract}
...
designs and compares two pseudo-labeling strategies: \textbf{EXP01(EXP09-05)}
...
augmentation; \textbf{EXP02(EXP11-01)} adopts a two-stage strategy --- Phase~0
...
%% fill both columns then force a new physical page (twocolumn mode)
\vspace*{\fill}
\newpage
\null\vspace*{\fill}
\newpage
