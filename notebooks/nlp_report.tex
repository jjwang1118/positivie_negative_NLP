...
\begin{@twocolumnfalse}
  \begin{center}
    ...
    \begin{tabular}{cccc}
      ...
      \small ID-001 & \small ID-002 & \small ID-003 & \small ID-004 \\
      \small \texttt{a@example.com} & \small \texttt{b@example.com}
        & \small \texttt{c@example.com} & \small \texttt{d@example.com}
    \end{tabular}
  \end{center}
  \vspace{4pt}
  \begin{abstract}
...
\textbf{EXP01} adopts a three-stage progressive unfreezing pipeline.
\textbf{EXP02} adopts a two-stage strategy using full pseudo-labels with
balanced class weights and Early Stopping. By controlling all other
conditions, this study compares the performance difference between the
two pseudo-labeling strategies in a low-resource sentiment analysis task.
